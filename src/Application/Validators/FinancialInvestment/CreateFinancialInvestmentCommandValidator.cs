...
public class CreateFinancialInvestmentCommandValidator : AbstractValidator<CreateFinancialInvestmentCommand>
{
    public CreateFinancialInvestmentCommandValidator()
    {
        RuleFor(x => x.Name)
            .NotNull()
